...
VALUES ('Beginners', 'Beginners session test', '2023-11-30', 2, '2023-10-30', '2023-10-30');

INSERT INTO USERS (first_name, last_name, admin, email, password, created_at, updated_at)
VALUES ('Admin', 'Admin', true, 'yoga@studio.com', '$2a$10$.Hsa/ZjUVaHqi0tp9xieMeewrnZxrZ5pQRzddUXE/WjDu2ZThe6Iq', '2023-10-30', '2023-10-30'),
       ('User', 'Test', false, 'user@test.com', '$2a$10$.Hsa/ZjUVaHqi0tp9xieMeewrnZxrZ5pQRzddUXE/WjDu2ZThe6Iq', '2023-10-30', '2023-10-30'); 
